...
#ifndef RTW_HEADER_CAN_NODE1_AUTO_private_h_
#define RTW_HEADER_CAN_NODE1_AUTO_private_h_
#include "rtwtypes.h"
#define CALL_EVENT                     (-1)
...
#endif                                 /* RTW_HEADER_CAN_NODE1_AUTO_private_h_ */
