 ...
 * Real-Time Workshop file generated on : Tue Dec 15 15:57:18 2020
 * TLC version                          : 7.5 (Jan 19 2010)
 * C/C++ source code generated on       : Tue Dec 15 15:57:19 2020
 *
...
#define CAN_NODE1_AUTO_IN_waring       (2U)
#define CAN_NODE1_AUTO_IN_working      (3U)
...
void CAN_NODE1_AUTO_step(void)
{
  ...
  if (CAN_NODE1_AUTO_DWork.is_active_c1_CAN_NODE1_AUTO == 0) {
    ...
    CAN_NODE1_AUTO_B.current_speed = 0.0;
    ...
    switch (CAN_NODE1_AUTO_DWork.is_c1_CAN_NODE1_AUTO) {
     case CAN_NODE1_AUTO_IN_wait:
      /* During 'wait': '<S1>:1' */
      if (CAN_NODE1_AUTO_U.waring == 1.0) {
        /* Transition: '<S1>:31' */
        /* Exit 'wait': '<S1>:1' */
        /* Entry 'waring': '<S1>:30' */
        CAN_NODE1_AUTO_DWork.is_c1_CAN_NODE1_AUTO = CAN_NODE1_AUTO_IN_waring;
        CAN_NODE1_AUTO_B.current_mode = 3.0;
        CAN_NODE1_AUTO_B.portb = (real_T)0x00;
      } else if (CAN_NODE1_AUTO_U.button_input_acc == 1.0) {
        /* Transition: '<S1>:29' */
        /* Exit 'wait': '<S1>:1' */
        /* Entry 'working': '<S1>:23' */
     ...
     case CAN_NODE1_AUTO_IN_waring:
      /* During 'waring': '<S1>:30' */
      if (CAN_NODE1_AUTO_U.waring == 0.0) {
        /* Transition: '<S1>:32' */
        /* Exit 'waring': '<S1>:30' */
        /* Entry 'wait': '<S1>:1' */
        CAN_NODE1_AUTO_DWork.is_c1_CAN_NODE1_AUTO = CAN_NODE1_AUTO_IN_wait;
  ...
  CAN_NODE1_AUTO_Y.current_speed = CAN_NODE1_AUTO_B.current_speed;
  ...
  /* Outport: '<Root>/msg2_2' */
  CAN_NODE1_AUTO_Y.msg2_2 = CAN_NODE1_AUTO_B.msg2_data_2_;
  ...
  /* Outport: '<Root>/msg1_2' */
  CAN_NODE1_AUTO_Y.msg1_2 = CAN_NODE1_AUTO_B.msg1_data_2_;
...
void CAN_NODE1_AUTO_initialize(void)
{
  ...
  CAN_NODE1_AUTO_B.msg2_data_2_ = 0.0;
  CAN_NODE1_AUTO_B.msg2_data_4_ = 0.0;
  CAN_NODE1_AUTO_B.msg1_data_0_ = 0.0;
  CAN_NODE1_AUTO_B.msg1_data_2_ = 0.0;
